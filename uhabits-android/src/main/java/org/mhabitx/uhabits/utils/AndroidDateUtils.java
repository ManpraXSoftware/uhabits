...
public class AndroidDateUtils
{
    ...
    {
        String shortDayNames[] = org.mhabitx.uhabits.core.utils.DateUtils.getShortDayNames();
        String longDayNames[] = org.mhabitx.uhabits.core.utils.DateUtils.getLongDayNames();
